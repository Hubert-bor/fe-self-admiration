...
export function getLocaleForPath(siteData: any | undefined, relativePath: string): string {
  return (
 ...
 */
export function resolveSiteDataByRoute(siteData: any, relativePath: string): any {
 ...
 */
export function createTitle(siteData: any, pageData: any): string {
...
function hasTag(head: any[], tag: any) {
...
export function mergeHead(prev: any[], curr: any[]) {
